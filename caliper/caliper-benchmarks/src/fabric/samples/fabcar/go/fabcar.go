...
func (s *SmartContract) Invoke(APIstub shim.ChaincodeStubInterface) sc.Response {
	...
	} else if function == "queryde" {
		return s.queryde(APIstub, args)
...
func (S *SmartContract) queryCarsByOwner(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	for i = 0; ownerAndIdResultIterator.HasNext(); i++ {
		...
		fmt.Printf("Found a car for index : %s cart id : ", objectType, compositeKeyParts[0], compositeKeyParts[1])
